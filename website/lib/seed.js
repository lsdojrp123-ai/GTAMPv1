...
function defaultSettings() {
  return {
    ...
    version: '1.6.0',
    downloadUrl: '/download/GTAMP-Launcher-v1.7.0.exe',
...
function defaultPosts() {
  return [
    { id: 1, cat: 'announcements', title: 'GTAMP v1.7.0 is live', body: 'FiveM-style launcher, remote players with nametags, F8 chat, and the new website.', uid: 1, at: Date.now() - 86400000 * 3 },

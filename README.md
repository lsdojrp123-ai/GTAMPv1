...
<p align="center">
  <a href="https://github.com/lsdojrp123-ai/GTAMPv1/releases/latest"><img src="https://img.shields.io/badge/latest-v1.9.7-e11d48?style=for-the-badge" alt="latest v1.9.7"></a>
...
| | |
|---|---|
| **Latest (v1.9.7)** | **[GTAMP-Launcher-v1.9.7.exe](https://github.com/lsdojrp123-ai/GTAMPv1/releases/download/v1.9.7/GTAMP-Launcher-v1.9.7.exe)** |
...
> **How to know you're on the new one:** the launch card's bottom-right footer must read **`GTAMP v1.9.7`**.
...
2. Download & run **GTAMP-Launcher-v1.9.7.exe** (portable — nothing to install).
...
- **🧟 Stale-window takeover.** If an old GTAMP window is frozen on your screen, running the new exe now *closes it for you* and takes over (FiveM -switchcl semantics — the new client always wins). No more running the new file and seeing the old UI.
...
| `GTAMP-Launcher-v1.9.7.exe` | Current launcher build (also attached to Releases) |
